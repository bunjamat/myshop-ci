                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">ยินดีต้อนรับ <br> จัดการระบบขายของออนไลน์</h1>
                                    </div>
                                    <form class="user" method="post" action="<?= base_url('') ?>admin/authen/auth">
                                        <div class="form-group">
                                            <input type="text" name="username" id="username" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="กรุณากรอกชื่อผู้ใช้งาน">
                                        </div>
                                        <div class="form-group">
