                        ...
                        <div class="row mb-3">
                            ...
                            <!-- <div class="col-lg-4">
                                <div class="input-group">
                                    ...
                                    <input id="start_date" name="start_date" data-date-format="mm/dd/yyyy"
...
<script>
    $('#approveModal').on('show.bs.modal', function(event) {
        ...
        modal.find('.modal-footer').html(
            ...
            dataID + ')" class="btn btn-primary">ยืนยันคำสั่งซื้อ</button>');
    })
    ...
    $(document).ready(function() {
        ...
        table = $('#food-table').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url() ?>ajaxdata/approvelist", // ไฟล์ Server script php
            ...
            'columns': [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if (data == 0) {
                            ...
                            return '<h5><span class="badge badge-pill badge-success">ขายแล้ว</span></h5>'
                        }
                        ...
                        if (data != null || data != '') {
                            ...
                            if (row.order_approve == 0) {
                                button +=
                                    ...
                                    data +
                                    '" data-username="' + row.us_fname + '" data-price="' +
                                    row.order_grandtotal + '" data-id="' +
                                    row.order_id + '">เรียกดูสลิป</button>';
                            }
                        }
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        button +=
                            '<a target="_blank" href="<?= base_url() ?>admin/manage/orderDetail/' + data + '" type="btton" class="btn btn-info">รายละเอียด</a>';
    ...
    function updateApprove(id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>admin/Manage/updateApprove",
            data: {
                id: id
            },
            dataType: "json",
