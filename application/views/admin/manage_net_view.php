...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">รายการสั่งซื้อทั้งหมด</h6>
        </div>
        <div class="card-body">
            <div class="row mb-2">
                <div class="col-lg-12">
                        ...
                        <div class="row mb-3">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend ">
                                        <span class="input-group-text bg-success text-white">
                                            ตั้งแต่วันที่ <i class="mdi mdi-calendar-range ml-2"></i>
                                        </span>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="input-group">
                                    ...
                                    <input id="end_date" name="end_date" data-date-format="mm/dd/yyyy" class="datepicker form-control" required>
                                </div>
                            </div>
                            <!-- <div class="col-lg-4">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.fn.dataTable.ext.buttons.exportExcel = {
            ...
            action: function(e, dt, node, config) { // กำหนดการทำงาน
                if (this.text() == 'ไฟล์ Excel') { // ถ้าปุ่มที่กด มีข้อความว่า  Excel All Page
                    window.open('<?= base_url() ?>admin/exportnet/excel?all=1&start=' + start_date + '&end=' + end_date); // ให้เปิดไฟล์ export.php?all=1 เรียกฟังก์ชั่น excel ดึงข้อมูลทั้งหมด
                } else {
                    window.open('<?= base_url('admin/export/excel') ?>'); // ให้เปิดไฟล์ export.php เรียกฟังก์ชั่น excel ดึงข้อมูลเฉพาะหน้าปัจจุบัน
                }
            }
        };
        ...
        table = $('#food-table').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url() ?>ajaxdata/Approvelistnet", // ไฟล์ Server script php
            ...
            "columnDefs": [ // กำหนดลักษณะพิเสษเฉพาะสำหรับคอลัมน์ตารางที่ต้องการ
                {
                    "targets": [0, 2, 3, 4], // เราต้องการกำหนดคอลัมน์แรก ค่าเริ่มต้นที่ 0
            ...
            "dom": '<"row col justify-content-between top-information"lBf>rt<"row col justify-content-between bottom-information"ip><"clear">',
            /* "aLengthMenu": [
                [5, 30, 50, 75, -1],
                [5, 30, 50, 75, "All"]
            ], */
