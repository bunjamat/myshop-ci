                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="fname" value="<?= $user['us_fname'] ?>" type="text" placeholder="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label>นามสกุล<span>*</span></label>
                                        <input name="lname" value="<?= $user['us_lname'] ?>" type="text" placeholder="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label>อีเมล<span>*</span></label>
                                        <input name="email" value="<?= $user['us_email'] ?>" type="text" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group message">
                                        <label>ที่อยู่สำหรับกรณีจัดส่ง<span></span></label>
                                        <textarea name="address" placeholder=""><?= $user['us_address'] ?></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="single-head">
                        <div class="single-info">
                            ...
                            <ul>
                                ...
                                <li>ชื่อ-สกุล : <?= $user['us_fname'] ?> <?= $user['us_lname'] ?></li>
                                <li>อีเมล : <?= $user['us_email'] ?></li>
                            </ul>
                        </div>
                        <div class="single-info">
...
<?php $this->load->view('templateuser/coreplugin'); ?>
<script>
    ...
    $("#form-profile").submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>users/profile/updateprofile",
            data: formData,
            dataType: "JSON",
            success: function(response) {
                ...
                if (response.status == 200) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            window.location.href = "<?= base_url() ?>users/authen/logout";
                        }
                    })
